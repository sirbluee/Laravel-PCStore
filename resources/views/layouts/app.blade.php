...
<head>
  ...
  <title>RUMPC | {{!empty($meta_title) ? $meta_title : ''}}</title>
  ...
  <link rel="shortcut icon" href="{{url('home/assets/images/logoweb.png')}}">

  <!-- Plugins CSS File -->
  <link rel="stylesheet" href="{{url('home/assets/css/bootstrap.min.css')}}">
  <link rel="stylesheet" href="{{url('home/assets/css/plugins/owl-carousel/owl.carousel.css')}}">
  <link rel="stylesheet" href="{{url('home/assets/css/plugins/magnific-popup/magnific-popup.css')}}">

  <!-- Main CSS File -->
  <link rel="stylesheet" href="{{url('home/assets/css/style.css')}}">
  <link rel="stylesheet" href="{{url('home/assets/css/plugins/owl-carousel/owl.carousel.css')}}">
  <link rel="stylesheet" href="{{url('home/assets/css/plugins/magnific-popup/magnific-popup.css')}}">
  <link rel="stylesheet" href="{{url('home/assets/css/plugins/nouislider/nouislider.css')}}">
</head>
...
<body>
  ...
  <script src="{{url('home/assets/js/jquery.hoverIntent.min.js')}}"></script>
  <script src="{{url('home/assets/js/jquery.waypoints.min.js')}}"></script>
  <script src="{{url('home/assets/js/superfish.min.js')}}"></script>
